...
export interface ApiContactDistributionListContactDistributionList
  extends Struct.CollectionTypeSchema {
  collectionName: 'contact_distribution_lists';
  info: {
    displayName: 'ContactDistributionList';
    pluralName: 'contact-distribution-lists';
    singularName: 'contact-distribution-list';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact-distribution-list.contact-distribution-list'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contactOption: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact-distribution-list.contact-distribution-list'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ActionButtonLink: Schema.Attribute.String;
    ActionButtonName: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::page.page'> &
      Schema.Attribute.Private;
    pageZone: Schema.Attribute.DynamicZone<
      [
        'pages.image',
        'pages.section',
        'pages.blog',
